...
extension PromptBuilder {
    func answerSolverPrompt(question: String) -> [DeepSeekMessage] {
        [
            ...
            对“most logically completes the text”“it can therefore be inferred”等推断题，必须区分“文本或来源未提及”与“作者不知道、材料不存在或材料不可得”。前者不能自动推出后者；不得选择加入作者心理状态、未证实材料可得性或其他原文没有给出的事实的选项。优先选择仅由明示时间线、来源范围和文本内容直接推出的结论。
    ...
    func answerCriticPrompt(question: String, proposal: AnswerVerification) -> [DeepSeekMessage] {
        [
            ...
            对完成文本或推断题，严查“未提及”被偷换成“作者不知道”“材料不存在”或“材料不可得”的过度推断。若一个选项只使用文中明确的时间线、来源和内容，而另一个选项额外断言作者的认知状态，优先前者。
